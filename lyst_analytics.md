...
The following screenshots illustrate the dbt model dependencies and flow:

### `fct_tracks` Lineage
![fct_tracks lineage](images/fct_tracks_lineage.jpeg)

### `fct_product_countries` Lineage
![fct_product_countries lineage](images/fct_product_countries_lineage.jpeg)
